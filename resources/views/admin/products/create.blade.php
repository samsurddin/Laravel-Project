        ...
        <div class="card">
            <div class="card-header">
                <div class="head position-relative overflow-hidden">
                    <h5 class="pt-2 float-start">Add New Product</h5>
                    <a href="{{ route('products.index') }}" class="btn btn-warning float-end">Go Back</a>
                </div>
            ...
            <form class="theme-form product-create" method="post" action="{{ route('products.store') }}">
                @csrf
                <input type="hidden" id="featured_img" name="featured_img" value="">
                    
                <div class="card-body">
                    @php
                        // dd([$categories, $brands, $specs])
                    @endphp

                    <div id="basic_info">
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="pro_name_input">Name</label>
                            <input name="name" class="form-control" id="pro_name_input" type="text" placeholder="Enter name" value="{{ old('name') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="pro_slug_input">Slug</label>
                            <input name="slug" class="form-control" id="pro_slug_input" type="text" placeholder="Enter slug" value="{{ old('slug') }}">
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="pro_sdesc_ta">Short Description</label>
                            <textarea name="short_description" class="form-control" id="pro_sdesc_ta" cols="30" rows="3" placeholder="Enter short description">{{ old('short_description') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="pro_desc_ta">Long Description</label>
                            <textarea name="description" class="form-control" id="pro_desc_ta" cols="30" rows="4" placeholder="Enter description">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div id="price_stock" class="pt-4 mt-5">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="regular_price" class="form-control" id="pro_regular_price_input" value="{{ old('regular_price') }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="pro_sale_price_input" class="form-label">Sale Price</label>
                                <input type="number" name="sale_price" class="form-control" id="pro_sale_price_input" value="{{ old('sale_price') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="sku" class="form-control" id="pro_sku_input" value="{{ old('sku') }}">
                            </div>
                            <div class="col-md-4">
                                <label for="pro_sku_input" class="form-label">Stock Quantity</label>
                                <input type="number" name="stock_quantity" class="form-control" id="pro_stock_quantity_input" value="{{ old('stock_quantity') }}">
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="stock_available" id="pro_stock_available_input" class="form-control">
                                    ...
                                    <option value="yes" {{ old('stock_available') == 'yes'?'selected':'' }}>Yes</option>
                                    <option value="no" {{ old('stock_available') == 'no'?'selected':'' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="qa_box" class="pt-4 mt-5">
                        <div class="mb-3">
                            ...
                            <input name="what_is_q" class="form-control" id="pro_what_is_q_input" type="text" placeholder="Enter what is question" value="{{ old('what_is_q') }}">
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="pro_what_is_a_ta">"What is" Answer</label>
                            <textarea name="what_is_a" class="form-control" id="pro_what_is_a_ta" cols="30" rows="3" placeholder="Enter what is answer">{{ old('what_is_a') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div id="specification_box" class="pt-4 mt-5">
                        <div class="row mb-3 position-relative spec-row">
                            ...
                            <div class="col-md-6 spec_val">
                                ...
                                <input type="text" name="spac_val[]" value="" class="form-control spac_val">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="image_box" class="images mb-3 pt-4 mt-5">
                        ...
                        <div id="img_preview" class="preview row"></div>
