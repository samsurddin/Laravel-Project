        ...
        <div class="card">
            <div class="card-header">
                <div class="head position-relative overflow-hidden">
                    ...
                    <a href="{{ route('admin.brands.index', app()->getLocale()) }}" class="btn btn-warning float-end">Go Back</a>
                </div>
            ...
            <form class="theme-form" method="post" action="{{ route('admin.brands.update', [app()->getLocale(), $brand->id]) }}">
                @csrf
                @method('PUT')
