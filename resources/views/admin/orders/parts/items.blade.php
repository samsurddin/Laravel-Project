            ...
            <tr class="item " data-order_item_id="25">
                ...
                <td class="name" data-sort-value="{{ $item['name'] }}">
                    ...
                    <div class="order-item-variation">
                        <strong>Variation ID:</strong> 71
                    </div>
                    <input type="hidden" class="order_item_id" name="order_item_id[]" value="25">
                    <input type="hidden" name="order_item_tax_class[25]" value=""> --}}
                </td>
                ...
                <td class="item_cost" width="1%" data-sort-value="498">
                    <div class="view">
                        <span class="price-amount amount">
                            ...
                            {{-- <bdi><span class="price-currency-symbol">৳&nbsp;</span>498</bdi> --}}
                        </span>
                    </div>
                </td>
                <td class="quantity">
                ...
                <td class="line_cost" data-sort-value="996">
                    <div class="view">
                        <span class="price-amount amount">
                            ...
                            {{-- <bdi><span class="price-currency-symbol">৳&nbsp;</span>996</bdi> --}}
                        </span>
                    </div>
                    <div class="edit" style="display: none;">
