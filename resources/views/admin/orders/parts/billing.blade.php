<div class="order-billing switch-btns-hover">
    <h6 class="overflow-hidden">
        <span class="col-title">Billing</span>
        <span class="float-end btns show-toggle">
            <a href="#" class="edit btn btn-sm btn-light text-primary switch-view" data-target="edit_address" data-alt-target="address" data-text="Edit" data-alt-text="Cancel" data-class="text-primary" data-alt-class="text-danger" data-icon="edit-2" data-alt-icon="slash"><i data-feather="edit-2"></i> Edit</a>
