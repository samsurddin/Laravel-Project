...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Admin Panel - Eastern IT</title>
        <!-- Google font-->
            ...
            <div class="page-header">
                <div class="header-wrapper row m-0">
                    ...
                    <div class="header-logo-wrapper col-auto p-0">
                        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('images/last_logo.png') }}" alt=""></a></div>
                        ...
                        <ul class="nav-menus">
                            ...
                            {{-- <li class="cart-nav onhover-dropdown">
                                ...
                                <ul class="cart-dropdown onhover-show-div">
                                    ...
                                    <li class="mt-0">
                                        <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{ asset('admin/assets/images/ecommerce/01.jpg') }}" alt="">
                                    ...
                                    <li class="mt-0">
                                        <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{ asset('admin/assets/images/ecommerce/03.jpg') }}" alt="">
                                            <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                                                <p>Yellow(#fcb102)</p>
                                                <div class="qty-box">
                                                    <div class="input-group"><span class="input-group-prepend">
                            ...
                            <li class="profile-nav onhover-dropdown p-0 me-0">
                                <div class="media profile-media">
                                    <img class="b-r-10" src="{{ asset('admin/assets/images/dashboard/profile.jpg') }}" alt="">
                ...
                <div class="sidebar-wrapper">
                    <div>
                        <div class="logo-wrapper">
                            <a href="index.html">
                                <img class="img-fluid for-light" src="{{ asset('images/last_logo.png') }}" alt="">
                                <img class="img-fluid for-dark" src="{{ asset('images/last_logo.png') }}" alt="">
                            </a>
                        ...
                        <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('images/last_logo.png') }}" alt=""></a></div>
                        <nav class="sidebar-main">
                            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                            <div id="sidebar-menu">
                                <ul class="sidebar-links" id="simple-bar">
                                    <li class="back-btn">
                                        <a href="index.html"><img class="img-fluid" src="{{ asset('images/last_logo.png') }}" alt=""></a>
