...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($category) {
            return redirect(route('categories.index'))->with('success', 'A new category is added successfully!');
        }
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect(route('categories.index'))->with('error', 'Somethong went wrong! Category cannot be deleted! Please try again!');
    }
}
